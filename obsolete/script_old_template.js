  ...
  .then((page_name) => {
    ...
    page_name.forEach((page) => {
      ...
      if (page.children.length > 0){
        ...
        // tmpl.querySelector(".sub_article_title").innerText = sub_page.article_name;         
        // tmpl.querySelector(".sub_article_title").setAttribute("href", page.page_link);
        // tmpl.querySelector(".sub_article_title").setAttribute("onclick", "return fetchArticle");
